...
extension Color {
    static let aetherBackground = Color(UIColor { t in
        t.userInterfaceStyle == .dark ? .black : .white
    })
    static let aetherSurface = Color(UIColor { t in
        t.userInterfaceStyle == .dark
            ? UIColor(white: 0.11, alpha: 1)
            : UIColor(white: 0.94, alpha: 1)
    })
    static let aetherSurfaceElevated = Color(UIColor { t in
        t.userInterfaceStyle == .dark
            ? UIColor(white: 0.17, alpha: 1)
            : UIColor(white: 0.88, alpha: 1)
    })
    static let aetherBorder = Color(UIColor { t in
        t.userInterfaceStyle == .dark
            ? UIColor(white: 0.22, alpha: 1)
            : UIColor(white: 0.78, alpha: 1)
    })
    static let aetherTextPrimary = Color(UIColor { t in
        t.userInterfaceStyle == .dark ? .white : .black
    })
    static let aetherTextSecondary = Color(UIColor { t in
        t.userInterfaceStyle == .dark
            ? UIColor(white: 0.6, alpha: 1)
            : UIColor(white: 0.35, alpha: 1)
    })
    static let aetherTextTertiary = Color(UIColor { t in
        t.userInterfaceStyle == .dark
    ...
    static func aetherBorder(for colorSchemeContrast: ColorSchemeContrast) -> Color {
    ...
    static let aetherSuccess = Color(UIColor { t in
        t.userInterfaceStyle == .dark
    ...
    static let aetherError = Color(UIColor { t in
        t.userInterfaceStyle == .dark
